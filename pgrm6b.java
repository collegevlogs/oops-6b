...
public static class StringOperations implements ActionListener{
JTextField tf1,tf2;
JButton b1,b2,b3,b4;
JLabel l1,l2;
StringOperations(){
...
public void actionPerformed(ActionEvent e){
    ...
    if(e.getSource()==b1){
        ...
        tf2.setText("The mid characters are "+s.charAt(mid-1)+" "+s.charAt(mid));
    }
    if(e.getSource()==b2){
        String reverse="";
        ...
        if(reverse.equals(s))
            tf2.setText("Entered text is palindrome");
        else
        tf2.setText("Entered text is  not a palindrome");
    }
    if(e.getSource()==b3){
       int count=0;
       char ch;
    ...
    if(e.getSource()==b4){
        tf2.setText("The length of string : "+length);
    }
